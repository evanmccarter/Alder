...
public class ColorPallet extends Component {
	...
	public static Color[] rainbow = { white, ghost, azure, honeydew, beige, lavender, silver, juniper, gray, quartzGray,
	...
	public static String[] rainbowNames = { "white", "ghost", "azure", "honeydew", "beige", "lavender", "silver",
	...
	public static Color invert(Color c) {
		return new Color(modulo255(255 - c.getRed()), modulo255(255 - c.getBlue()), modulo255(255 - c.getGreen())); // invert
																													// back
																													// and
																													// forth
	}
